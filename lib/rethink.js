...
.then(function (connection) {
    ...
    module.exports.findArray = function (tableName, items) {
      ...
      return rdb.table('events').getAll(r.args([ '46dfb2f0-89e7-461b-82a5-e0dbc2a97cd3','8bd2202a-7854-4c9f-b2ff-12b9513c883e' ])).run(connection)
      .then(function (cursor) { 
          console.log('this does not ever resolve for some reason:', cursor);
          return cursor.toArray();
      }); 
    };
